    ...
    sidebar.prototype = {
        scroll:function(){
            ...
            //                 '<a href="javascript:;" class="arrow-up lock"><i class="portalfont icon-arrow-up"></i></a>'+
            //                 '<a href="javascript:;" class="arrow-down"><i class="portalfont icon-arrow-down"></i></a>'+
            //             '</div>';
            ...
            function scroll(value){
                ...
                else if(_this.curNum>_this.num-showNum+1) {
                    _this.curNum=_this.num-showNum+1;
                ...
                if(u.isIE8||u.isIE9){
                    ...
                    $(_this.container).animate({'top':(-_this.curNum*60)+'px'},'300','swing')
                }
                else {
                    _this.container.css({'transform':'translateY('+(-_this.curNum*60)+'px)','-ms-transform':'translateY('+(-_this.curNum*60)+'px)'});
                }
            }
        ...
        initMenuList:function(){
            ...
            $.ajax({
                url: "data/sidebardata.json?random="+Math.random(),
                type: 'GET',
                dataType: 'json',
